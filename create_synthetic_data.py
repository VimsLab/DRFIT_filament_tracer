...
'''
def create_curves(width, height, num_cp, num_points, L,deform_down = 1, deform_up = 10 ):
        ...
        for width in widths:
            ...
            for status_use in status:
                for kernel_size in kernel_size_list:
                    gt_file = os.path.join('./dataset/', 'curve_coco_'+status_use + '_lstm_' +\
                        str(number_of_images)+'_' +  str(width) +'_kernel_' + str(kernel_size) +\
                            '_step_' + str(cp_step) + '.json')

                    directory_curve_pool = './dataset/curve_coco_'+status_use + '_lstm_' +\
                        str(number_of_images)+'_' +  str(width) +'_kernel_' + str(kernel_size)+\
                            '_step_' + str(cp_step)
                    ...
                    for i in tqdm(range(number_of_images)):
                        ...
                        ################
                        if width < 512:
                            num_of_curves = random.randint(3,8)
                        ...
                        for ii in range(num_of_curves):
                            ...
                            num_cp = random.randint(4,8)
                            deform_up = random.randint(8,15)
                            ####################
                            
                            # create curves
                            # 
                            im, im_pts_v3 = create_curves(width, height, num_cp, num_points, L, deform_up=deform_up)
